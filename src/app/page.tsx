      ...
      <div style={{
        ...
        <div style={{ marginBottom: 80 }}>
          ...
          <p style={{
            ...
            TenPhel helps you monitor your spending, understand your financial habits, and take control of your money with ease.
          </p>
          <button
            ...
            onMouseEnter={(e) => {
              e.currentTarget.style.boxShadow = '0 15px 40px rgba(124,111,247,0.4)'
              e.currentTarget.style.transform = 'translateY(-2px)'
            }}
            onMouseLeave={(e) => {
              e.currentTarget.style.boxShadow = '0 10px 30px rgba(124,111,247,0.3)'
        ...
        <div style={{
          padding: 48,
          background: 'linear-gradient(135deg, rgba(124,111,247,0.1) 0%, rgba(91,78,224,0.05) 100%)',
          borderRadius: 20,
          border: '1px solid var(--border)',
          marginBottom: 40,
        }}>
          ...
          <p style={{
            ...
            Join thousands of students managing their finances smartly with TenPhel
          </p>
          <button
            onClick={() => router.push('/auth?step=register')}
            style={{
